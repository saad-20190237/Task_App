...
public class TaskListController {
    ...
    @PostMapping
    public TaskListDto createTaskList(@RequestBody TaskListDto requestDto) {
        TaskList createdTaskList = taskListService.craeteTaskList(taskListMapper.fromTaskListDto(requestDto));
